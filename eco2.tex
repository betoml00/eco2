...
\definecolor{miAzul2}{RGB}{77, 89, 161}
\definecolor{miMorado}{RGB}{88, 43, 67}
\definecolor{miMorado2}{RGB}{100,0,100}
...
\draw[dashed, black!10!gray] (2.5,3.049) -- (0,3.049) node[anchor=east] {$i$};
\draw[dashed, black!10!gray] (2.5,1.349) -- (0,1.349) node[anchor=east] {$i'$};
\draw[dashed, black!10!gray] (2.5,3.049) -- (2.5,0) node[anchor=north] {$Y$};

\addplot[miAzul2, name path=G,domain={0.6:4.2}, very thick]{0.08*(x+1.9)^2-0.2};
\node[anchor=center,label=east:{\color{miAzul2}$LM'$ ($\frac{M'}{P} >\frac{M}{P}$)}] at (axis cs:4.2,2.777){};

\addplot[miAzul, name path=F,domain={0.6:4.2}, very thick]{0.08*(x+1.9)^2+1.5};
\node[anchor=center,label=east:{\color{miAzul}$LM$ ($\frac{M}{P}$)}] at (axis cs:4.2,4.477){};

\draw[-{Triangle[width=8pt,length=4pt]}, line width=3pt, miAzul2] (3.4,3.2)--(3.4,2.6);
        
\filldraw[black] (2.5,3.049) circle (1.5pt);
\filldraw[black] (2.5,1.349) circle (1.5pt);
...
\draw[dashed, black!10!gray] (2.5,1.923) -- (0,1.923) node[anchor=east] {$i$};
\draw[dashed, black!10!gray] (2.5,1.923) -- (2.5,0) node[anchor=north] {$Y$};

\addplot[miRojo, name path=G,domain={0.8:4.2}, very thick]{0.12*(x-6.9)^2-0.4};
\node[anchor=center,label=east:{\color{miRojo}$IS$}] at (axis cs:4.2,0.475){};

\addplot[miAzul, name path=F,domain={0.8:4.2}, very thick]{0.12*(x+1.9)^2-0.4};
\node[anchor=center,label=east:{\color{miAzul}$LM$}] at (axis cs:4.2,4){};
        
\filldraw[black] (2.5,1.923) circle (1.5pt)node[anchor=west, xshift=2pt]{$A$};
...
Si igualamos la ecuación de salarios con la ecuación de precios, entonces vemos que
\[ F(u_n, z) = \frac{1}{1+m}. \]
La tasa de desempleo de equilibrio, $u_n$, se denomina la \textbf{tasa natural de desempleo}. Las posiciones de las curvas de fijación de los salarios y de los precios y, por tanto, la tasa de desempleo de equilibrio, dependen tanto de $z$ como de $m$.
...
\draw[dashed, black!10!gray] (1.984,2.5) -- (1.984,0) node[anchor=north] {$u_n$};

\draw[black!90!gray, very thick] (0, 2.5) -- (4.2, 2.5) node[anchor=west] {$PS$};
\node[anchor=center,label=west:{\color{black!10!gray}$\frac{1}{1+m}$}] at (axis cs:0,2.5){};

\addplot[miMorado2, name path=G,domain={0.4:4.2}, very thick]{0.12*(x-6.9)^2-0.4};
\node[anchor=center,label=east:{\color{miMorado2}$WS$}] at (axis cs:4.2,0.475){};
        
\filldraw[black] (1.984,2.5) circle (1.5pt)node[anchor=south west]{$A$};
